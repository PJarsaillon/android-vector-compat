...
public class AnimatedVectorView extends ImageView {
    ...
    public AnimatedVectorView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a =
            theme.obtainStyledAttributes(
                attrs,
                com.wnafee.vector.R.styleable.MorphButton,
                defStyleAttr,
                0);

        int startResId =
            a.getResourceId(com.wnafee.vector.R.styleable.MorphButton_vc_startDrawable, -1);
        int endResId =
            a.getResourceId(com.wnafee.vector.R.styleable.MorphButton_vc_endDrawable, -1);
        boolean autoStart =
            a.getBoolean(com.wnafee.vector.R.styleable.MorphButton_vc_autoStartAnimation, false);

        final int st = a.getInt(com.wnafee.vector.R.styleable.MorphButton_android_scaleType, -1);
        if (st >= 0) {
    ...
    private void readTintAttributes(TypedArray a) {
        ...
        mBackgroundTint.mTintList =
            a.getColorStateList(com.wnafee.vector.R.styleable.MorphButton_vc_backgroundTint);
        ...
        mBackgroundTint.mTintMode = DrawableCompat.parseTintMode(a.getInt(
            com.wnafee.vector.R.styleable.MorphButton_vc_backgroundTintMode, -1), null);
        mBackgroundTint.mHasTintMode = mBackgroundTint.mTintMode != null;

        mForegroundTint.mTintList =
            a.getColorStateList(com.wnafee.vector.R.styleable.MorphButton_vc_foregroundTint);
        ...
        mForegroundTint.mTintMode = DrawableCompat.parseTintMode(a.getInt(
            com.wnafee.vector.R.styleable.MorphButton_vc_foregroundTintMode, -1), null);
